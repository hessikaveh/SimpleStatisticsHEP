A simple test, to show the difficulties that may happen when one deals with systematic variations and bin-by-bin uncertainties at the same time in a maximum likelihood fit.
